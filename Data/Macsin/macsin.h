...
namespace Macsin {
    ...
    //RECORD 6
        QVector<Material::Material> materials;
    public:
        Macsin();
        ...
        QVector<Material::Material> getMaterials() const;
        void setMaterials(const QVector<Material::Material> &value);
    };
